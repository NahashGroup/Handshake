...
class Captcha
{
    ...
    private function generate()
    {
        ...
        for ($i = 1; $i < 5; $i++) {
            ...
            imagettftext($this->imageResource, $fontSize, rand(-35, 35), 35 * $i, 55, imagecolorallocate($this->imageResource, rand(70, 240), rand(0, 240), rand(0, 240)), $this->font, $char);
        }
